...
import prac3a_epy_block_1 as epy_block_1  # embedded python block
import sip
...
class prac3a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.epy_block_1, 4), (self.qtgui_number_sink_0_0, 0))
        self.connect((self.epy_block_1, 3), (self.qtgui_number_sink_0_1, 0))
        self.connect((self.epy_block_1, 1), (self.qtgui_number_sink_0_2, 0))
        self.connect((self.epy_block_1, 2), (self.qtgui_number_sink_0_3, 0))
