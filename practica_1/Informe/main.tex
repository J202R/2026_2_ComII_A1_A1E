...
Se implementaron y modificaron los bloques personalizados en Python (\textit{Embedded Python Block} \cite{wikipediaPythonBlocks}) propuestos por el libro guia\cite{ortega2019comunicaciones} 
...
4 muestras y una escala de $1/M$ para realizar correctamente los promedios temporales y cumplir con la frecuencia máxima $f_{max}=40Hz$.
...
diferenciador respondió correctamente ante la señal de entrada constante en la cual se observó el comportamiento adecuado, dando como resultado una salida con valor cero, de igual manera para la rampa se presento la salida correcta. De igual forma, en la figura 
