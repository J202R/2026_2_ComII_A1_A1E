...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_number_sink_4.set_title("Desviación estándar ")
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_moving_average_xx_0, 0))
        ...
        self.connect((self.blocks_moving_average_xx_0, 0), (self.qtgui_time_sink_x_0_0, 1))
