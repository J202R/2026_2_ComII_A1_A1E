...
import sip
import untitled_epy_block_2 as epy_block_2  # embedded python block
...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.desviaciónestandar = qtgui.number_sink(
            gr.sizeof_float,
            0,
        ...
        self.desviaciónestandar.set_update_time(0.10)
        self.desviaciónestandar.set_title("desviación estandar")
        ...
        for i in range(1):
            self.desviaciónestandar.set_min(i, -1)
            self.desviaciónestandar.set_max(i, 1)
            self.desviaciónestandar.set_color(i, colors[i][0], colors[i][1])
            if len(labels[i]) == 0:
                self.desviaciónestandar.set_label(i, "Data {0}".format(i))
            else:
                self.desviaciónestandar.set_label(i, labels[i])
            self.desviaciónestandar.set_unit(i, units[i])
            self.desviaciónestandar.set_factor(i, factor[i])

        self.desviaciónestandar.enable_autoscale(False)
        self._desviaciónestandar_win = sip.wrapinstance(self.desviaciónestandar.qwidget(), Qt.QWidget)
        self.top_layout.addWidget(self._desviaciónestandar_win)
        ...
        self.connect((self.analog_noise_source_x_0, 0), (self.qtgui_time_sink_x_0_1, 0))
        ...
        self.connect((self.epy_block_2, 1), (self.Mediacuadratica, 0))
        self.connect((self.epy_block_2, 3), (self.Potenciapromedio, 0))
        self.connect((self.epy_block_2, 2), (self.RMS, 0))
        self.connect((self.epy_block_2, 4), (self.desviaciónestandar, 0))
